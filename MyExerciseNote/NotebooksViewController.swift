...
class NotebooksViewController: CoreDataTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // This method must be implemented by our subclass. There's no way CoreDataTableViewController can know what type of cell we want to use.
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier! == "displayNote" {
            ...
            if let notesVC = segue.destination as? NotesViewController {
                ...
                // So far we have a search that will match All notes. However, we're only interested in those within the current notebook: NSPredicate to the rescue!
                ...
                notesVC.notebook = notebook as! Notebook?
            }
        }
    }
}
